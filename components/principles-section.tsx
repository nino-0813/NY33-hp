  ...
  const principles = [
    {
      number: "01",
      titleParts: [
        { text: "目的", highlight: true },
        { text: "から逆算する", highlight: false },
      ],
      description: "「何を伝え、誰に届けたいか」を最初に据え、サイト構成・デザイン・文言まで一貫して設計します。",
      align: "left",
    },
    {
      number: "02",
      titleParts: [
        { text: "集客", highlight: true },
        { text: "と成果を設計する", highlight: false },
      ],
      description: "認知から問い合わせ・成約までの道筋を設計し、持続的に集客できる仕組みをつくります。",
      align: "right",
    },
    {
      number: "03",
      titleParts: [
        { text: "シンプルで ", highlight: false },
        { text: "届く表現", highlight: true },
      ],
      description: "余計な要素を削り、伝えたいことがひと目でわかるデザインとコピーを心がけています。",
      align: "left",
    },
    {
      number: "04",
      titleParts: [
        { text: "現場に ", highlight: false },
        { text: "寄り添う", highlight: true },
      ],
      description: "ツールや施策はお任せいただく現場に合わせて提案。運用しやすさと効果の両立を目指します。",
      align: "right",
    },
  ]
  ...
  return (
    <section ref={sectionRef} id="principles" className="relative py-32 pl-6 md:pl-28 pr-6 md:pr-12">
      ...
      <div ref={headerRef} className="mb-24">
        ...
        <h2 className="mt-4 font-[var(--font-bebas)] text-5xl md:text-7xl tracking-tight">私たちの考え方</h2>
      </div>
