...
const signals = [
  {
    date: "2025.06.10",
    title: "新規サイト公開",
    note: "お客様のコーポレートサイトを企画・制作し、公開いたしました。",
  },
  {
    date: "2025.05.28",
    title: "SEO施策開始",
    note: "検索流入を増やすためのキーワード設計とコンテンツ計画をスタート。",
  },
  {
    date: "2025.05.15",
    title: "LP制作事例",
    note: "キャンペーン用ランディングページの制作とABテスト運用を実施。",
  },
  {
    date: "2025.04.30",
    title: "集客動線の設計",
    note: "認知から問い合わせまでの導線設計とチャネル設計をご提案。",
  },
  {
    date: "2025.04.12",
    title: "AIO活用のご相談",
    note: "AIツールの導入・活用に関するコンサルティングを開始。",
  },
]
  ...
  return (
    <section id="signals" ref={sectionRef} className="relative py-32 pl-6 md:pl-28">
      ...
      <div ref={headerRef} className="mb-16 pr-6 md:pr-12">
        <span className="font-mono text-[10px] uppercase tracking-[0.3em] text-accent">01 / News</span>
